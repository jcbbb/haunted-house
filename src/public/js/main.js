...
const doorColorTexture = textureLoader.load("/public/assets/textures/door/color.jpg");
const doorAlphaTexture = textureLoader.load("/public/assets/textures/door/alpha.jpg");
const doorAmbientOcclusionTexture = textureLoader.load(
  "/public/assets/textures/door/ambientOcclusion.jpg"
);
const doorHeightTexture = textureLoader.load("/public/assets/textures/door/height.jpg");
const doorMetalnessTexture = textureLoader.load("/public/assets/textures/door/metalness.jpg");
const doorNormalTexture = textureLoader.load("/public/assets/textures/door/normal.jpg");
const doorRoughnessTexture = textureLoader.load("/public/assets/textures/door/roughness.jpg");

const bricksColorTexture = textureLoader.load("/public/assets/textures/bricks/color.jpg");
const bricksAmbientOcclusionTexture = textureLoader.load(
  "/public/assets/textures/bricks/ambientOcclusion.jpg"
);
const bricksNormalTexture = textureLoader.load("/public/assets/textures/bricks/normal.jpg");
const bricksRoughnessTexture = textureLoader.load("/public/assets/textures/bricks/roughness.jpg");

const grassColorTexture = textureLoader.load("/public/assets/textures/grass/color.jpg");
const grassAmbientOcclusionTexture = textureLoader.load(
  "/public/assets/textures/grass/ambientOcclusion.jpg"
);
const grassNormalTexture = textureLoader.load("/public/assets/textures/grass/normal.jpg");
const grassRoughnessTexture = textureLoader.load("/public/assets/textures/grass/roughness.jpg");
